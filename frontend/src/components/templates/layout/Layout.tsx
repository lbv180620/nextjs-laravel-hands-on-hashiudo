...
export const Layout: FC<PropsType> = ({ children, title = "Default title" }) => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center font-mono">
      ...
      <footer className="flex h-6 w-full items-center justify-center text-sm text-gray-500">@Hashiudo 2022</footer>
    </div>
  );
};
